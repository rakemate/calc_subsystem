...
class ahb_apb_single_write_test extends ahb_apb_base_test;
    ...
    axi_single_write_sequence axi_seq_h;
...
class ahb_apb_single_rd_test extends ahb_apb_base_test;
    `uvm_component_utils(ahb_apb_single_rd_test)
    ...
    // Constructor
    function new(string name = "ahb_apb_single_rd_test", uvm_component parent);
        super.new(name, parent);
    endfunction
